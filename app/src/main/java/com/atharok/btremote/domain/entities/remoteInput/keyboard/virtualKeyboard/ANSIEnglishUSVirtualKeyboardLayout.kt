...
class ANSIEnglishUSVirtualKeyboardLayout : VirtualKeyboardLayout() {

    override val keyboardInputs: Map<Char, ByteArray> by lazy {
        mapOf(
    ...
    override val extraInputs: Map<Char, ByteArray> by lazy {
        mapOf(
