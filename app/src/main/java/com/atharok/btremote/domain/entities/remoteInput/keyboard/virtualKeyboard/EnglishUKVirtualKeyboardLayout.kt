...
class EnglishUKVirtualKeyboardLayout : VirtualKeyboardLayout() {
    ...
    protected override val keyboardInputs: Map<Char, ByteArray> by lazy {
        mapOf(
            ...
            'ẃ' to getKeyboardReport(0x40, KeyboardKey.ROW_2_KEY_01.byte),
            'é' to getKeyboardReport(0x40, KeyboardKey.ROW_2_KEY_02.byte),
            'ý' to getKeyboardReport(0x40, KeyboardKey.ROW_2_KEY_05.byte),
            'ú' to getKeyboardReport(0x40, KeyboardKey.ROW_2_KEY_06.byte),
            'í' to getKeyboardReport(0x40, KeyboardKey.ROW_2_KEY_07.byte),
            'ó' to getKeyboardReport(0x40, KeyboardKey.ROW_2_KEY_08.byte),

            'á' to getKeyboardReport(0x40, KeyboardKey.ROW_3_KEY_00.byte),

            'ç' to getKeyboardReport(0x40, KeyboardKey.ROW_4_KEY_03.byte),

            // ---- Shift + Alt Gr ----

            'Ẃ' to getKeyboardReport(0x42, KeyboardKey.ROW_2_KEY_01.byte),
            'É' to getKeyboardReport(0x42, KeyboardKey.ROW_2_KEY_02.byte),
            'Ý' to getKeyboardReport(0x42, KeyboardKey.ROW_2_KEY_05.byte),
            'Ú' to getKeyboardReport(0x42, KeyboardKey.ROW_2_KEY_06.byte),
            'Í' to getKeyboardReport(0x42, KeyboardKey.ROW_2_KEY_07.byte),
            'Ó' to getKeyboardReport(0x42, KeyboardKey.ROW_2_KEY_08.byte),

            'Á' to getKeyboardReport(0x42, KeyboardKey.ROW_3_KEY_00.byte),

            'Ç' to getKeyboardReport(0x42, KeyboardKey.ROW_4_KEY_03.byte)
        )
    }
